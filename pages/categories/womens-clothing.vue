<template>
  <div>
    <NavMenu />
    <h1 class="text-3xl font-bold mt-10 text-center">Womens's Clothing</h1>
    <div class="flex container my-24 px-6 mx-auto">
      <section class="text-gray-800 text-center flex flex-wrap justify-center">
        <div 
          class="flex flex-wrap"
          v-for="product in products"
            :key="product.id"
          >
          <div v-if="product.category == womens">
          <div
